...
-- ============================================================================
-- 20251002230000_create_receipts_storage_bucket.sql (BEREINIGT)
-- ============================================================================

/*
  # Create Receipts Storage Bucket (ohne ALTER TABLE storage.objects)
...
-- Create the receipts bucket (storage.objects RLS wird NICHT geändert)
