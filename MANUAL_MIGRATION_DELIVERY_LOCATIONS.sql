-- ================================================
-- MANUAL MIGRATION: Delivery Locations
-- Datum: 2. Oktober 2025
--
-- ANLEITUNG:
-- 1. Öffnen Sie Ihre Supabase Dashboard
-- 2. Gehen Sie zu "SQL Editor"
-- 3. Erstellen Sie eine neue Query
-- 4. Kopieren Sie dieses gesamte SQL-Skript
-- 5. Führen Sie es aus
-- ================================================
...
-- Verification Query (optional - run this to verify the migration was successful)
-- SELECT
--   table_name,
--   column_name,
--   data_type
...
--
-- Überprüfung:
-- 1. Tabelle 'delivery_locations' erstellt
-- 2. RLS aktiviert mit 4 Policies
-- 3. 7 Indizes erstellt
-- 4. Foreign-Key-Spalten zu invoices, delivery_notes, invoice_items hinzugefügt
-- 5. Funktion generate_next_location_number() erstellt
-- 6. Trigger für updated_at erstellt
-- ================================================
