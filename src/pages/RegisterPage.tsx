      ...
      <div className="w-full max-w-2xl">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">14 Tage kostenlos testen, keine Kreditkarte erforderlich</p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="acceptTerms" className="text-gray-700">
                  Ich akzeptiere die{' '}
                  <a href="/agb" className="text-indigo-600 hover:text-indigo-500" target="_blank">
                    AGB
                  </a>{' '}
                  und{' '}
                  <a href="/datenschutz" className="text-indigo-600 hover:text-indigo-500" target="_blank">
