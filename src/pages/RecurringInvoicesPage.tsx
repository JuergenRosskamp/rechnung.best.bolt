    ...
    <Layout>
      <div className="p-4 md:p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Wiederkehrende Rechnungen</h1>
            <p className="text-sm text-gray-600 mt-1">Abo-Verwaltung & Recurring Revenue</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <div className="card p-4">
            <p className="text-sm text-gray-600 font-medium">Aktive Abos</p>
            <p className="text-3xl font-bold text-gray-900 mt-1">{stats.active_subscriptions}</p>
          </div>

          <div className="card p-4">
            <p className="text-sm text-gray-600 font-medium">Pausiert</p>
        ...
        {isLoading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-500">Lade Abos...</p>
          </div>
        ) : filteredSubscriptions.length === 0 ? (
          <div className="card p-12 text-center">
            <Calendar className="mx-auto h-12 w-12 text-gray-400" />
            <h3 className="mt-4 text-lg font-medium text-gray-900">Keine Abos gefunden</h3>
                ...
                {filteredSubscriptions.map((sub) => (
                  <tr key={sub.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      <span className="text-sm font-medium text-gray-900">{sub.template_name}</span>
                    </td>
                    <td className="px-4 py-3">
                      <div className="text-sm text-gray-900">{sub.customer.display_name}</div>
                      <div className="text-xs text-gray-500">{sub.customer.customer_number}</div>
                    </td>
